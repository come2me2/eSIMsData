...
1. **API Client** (`api/esimgo/client.js`) - базовый клиент для работы с API v2.4
2. **OpenAPI Schema** (`esim_go_schema_v2_4.yaml`) - полная спецификация API v2.4.0
3. **API Endpoints**:
...
4. **Тестовая страница** (`test-esimgo.html`) - для проверки подключения
