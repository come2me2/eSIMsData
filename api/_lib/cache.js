...
const CACHE_TTL = {
    countries: 10 * 60 * 1000,      // 10 минут - список стран меняется редко
    plans: 5 * 60 * 1000,          // 5 минут - планы могут обновляться чаще
    regionPlans: 5 * 60 * 1000,    // 5 минут
    globalPlans: 5 * 60 * 1000     // 5 минут
};
