        ...
        tbody.innerHTML = orders.map(order => {
            ...
            return `
                <tr class="table-row hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900">$${parseFloat(order.finalPrice || order.price || '0.00').toFixed(2)}</td>
                    ...
                    <div>
                        ...
                        <div class="bg-gray-50 rounded-lg p-5 space-y-4">
                            ...
                            <div class="flex items-start justify-between pt-3 border-t border-gray-200">
                                ...
                                <span class="ml-4 font-bold text-xl text-blue-600">$${parseFloat(order.finalPrice || order.price || '0.00').toFixed(2)}</span>
                            </div>
                            <div class="flex items-start justify-between">
