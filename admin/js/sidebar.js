...
function initializeSidebar() {
    ...
    const sidebarHTML = `
        ...
        <nav class="mt-8">
            <a href="index.html" class="flex items-center px-6 py-3 text-gray-300 hover:bg-gray-700 hover:text-white ${window.location.pathname.includes('index.html') ? 'active-nav' : ''}">
        ...
        <div class="absolute bottom-0 left-0 right-0 p-6 border-t border-gray-700 space-y-4">
            <!-- Language Selector -->
            <div class="mb-4">
                <label class="block text-gray-400 text-xs mb-2" data-i18n="language">Language</label>
